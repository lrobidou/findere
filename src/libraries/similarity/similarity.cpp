...
std::tuple<int, int> computeSimilarityUsingQTFNoSplitKmer(bf::basic_bloom_filter* filter, const std::string& s, unsigned int k, const unsigned long long& nbNeighboursMin, const unsigned int& epsilon_percent) {
