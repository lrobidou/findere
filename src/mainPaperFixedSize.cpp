...
int main(int argc, char* argv[]) {
    ...
    std::vector<unsigned long long> membits = {6644980503, 9864424526, 13083868549, 16303312573, 19522756596, 22742200619, 25961644643, 29181088666, 32400532689, 35619976713};
